...
data = json.loads(open('./conf5.json').read())
...
driver.find_element_by_xpath("//input[@name='Email Address']").send_keys("xxx")
...
driver.find_element_by_xpath("//*[contains(@title,'Link to Next')]").click()
